    ...
    <main class="dashboard-container">
        <section class="quick-links">
            ...
            <div class="cards">
                ...
                <a href="enrollment-management.jsp" class="card" role="button">
                    <h3>Enrollment Management</h3>
                    <p>View and manage course enrollments.</p>
                </a>
                <a href="assignment-management.jsp" class="card" role="button">
                    <h3>Assignment Management</h3>
                    <p>View and submit assignments.</p>
                </a>
                <a href="submission-management.jsp" class="card" role="button">
                ...
                <a href="User-management.jsp" class="card" role="button">
